...
function fillOutRecipe(data){
    console.log(getTitle(data));
        ...
        document.getElementById("cookTime").innerHTML=convertTime(searchForKey(data, 'totalTime'));
        document.getElementById("dateOfCreation").innerHTML=searchForKey(data, 'datePublished').split('T')[0];
