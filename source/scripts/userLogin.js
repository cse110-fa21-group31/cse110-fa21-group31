...
import { ELE_CLASS_PROFILE_IMAGE, ELE_ID_PROFILE, ELE_ID_PROFILE_WRAPPER, 
 SIGN_IN_BUTTON_ID, SIGN_OUT_BUTTON_ID } from "./util.js";
...
function onSignIn(googleUser) {
  ...
  imageWrapper.onclick = () => {alert("Test: Profile Picture Clicked")};
